...
class Menu():
    ...
    def menu(self, window):
        ...
        combobox = Combobox(frame6, textvariable=self.unused_ref, values=ans, state='readonly')
        ...
        combobox = Combobox(window, textvariable=self.identic_type, values=days, state='readonly')
        combobox.pack(fill='x', padx=5, pady=5)
